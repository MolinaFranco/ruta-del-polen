...
export const hostPlants: Plant[] = [
  {
    id: 'sen-del-campo',
    kind: 'host',
    commonName: 'Sen del campo',
    otherNames: 'Rama negra, casia',
    scientificName: 'Senna corymbosa',
    family: 'Fabáceas',
    origin: 'Nativa del centro y norte de Argentina',
    habit: 'Arbusto',
    height: '1,5 a 3 m',
    bloom: 'Racimos amarillos de verano a otoño',
    summary:
      'Arbusto rústico de hojas compuestas que se cubre de flores amarillas. Sus hojas tiernas y pimpollos son el alimento de las orugas de las limoneras y limoncitos.',
    balconyFit: 'large-pot',
    pollinators: ['bumblebees', 'bees'],
    pollinatorNote: 'Los abejorros hacen vibrar la flor para liberar el polen.',
    garden: {
      depth: 'Hoyo de 40 × 40 cm. Su raíz es pivotante (crece recta hacia abajo), así que agradece tierra profunda.',
      substrate: 'Tierra común, suelta y con buen drenaje. Tolera suelos pobres.',
      sun: 'Pleno sol. Tolera algo de media sombra, pero florece menos.',
      watering: 'Medio. Una vez establecido (al año) resiste bien la sequía.',
      germination:
        'La semilla tiene cáscara dura: lijala suavemente o dejala 12 h en agua caliente. Sembrá a 1 cm en primavera; nace en 2 a 4 semanas.',
      tip: 'No fumigues: las orugas verdes que aparecen son justamente las futuras limoneras.',
    },
    balcony: {
      depth: 'Maceta profunda, de 40 cm o más (30 a 40 litros), por su raíz pivotante.',
      substrate: '60 % tierra fértil, 20 % compost y 20 % arena gruesa o perlita.',
      sun: 'Al menos 6 horas de sol directo.',
      watering: 'Dos o tres veces por semana en verano, sin encharcar. Una vez por semana en invierno.',
      germination:
        'Igual que en jardín: escarificá la semilla y sembrá a 1 cm. Conviene sembrar directo en la maceta definitiva para no dañar la raíz.',
      tip: 'Podalo después de la floración para mantenerlo entre 1 y 1,5 m.',
    },
  },
  {
    id: 'patito',
